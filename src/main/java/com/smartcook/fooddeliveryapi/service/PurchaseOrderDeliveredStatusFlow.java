...
public class PurchaseOrderDeliveredStatusFlow implements PurchaseOrderStatusFlow {

	@Override
	public void confirm(PurchaseOrder purchaseOrder) {
		// M-27=It is not possible to change Purchase Order status from {0} to {1}.
		throw new ServiceException("M-27", purchaseOrder.getOrderStatus().getDescription(), OrderStatus.CONFIRMED.getDescription());
	}
