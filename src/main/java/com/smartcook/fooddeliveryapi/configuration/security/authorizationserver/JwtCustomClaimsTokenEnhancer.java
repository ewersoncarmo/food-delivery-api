...
public class JwtCustomClaimsTokenEnhancer implements TokenEnhancer {
	...
	public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
		// Necessary to guarantee that only the authentication performed by final users should be executed
		// Example: 
		// - Resource owner password credentials grant should be executed
		// - Client credentials grant shouldn't be executed
